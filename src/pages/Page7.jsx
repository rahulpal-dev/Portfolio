...
import bgImage from "../assets/images/page7Img.webp";
...
const Page7 = () => {
  ...
  return (
    <section
      ...
      aria-label="Website development and digital experience"
    >
      <div
        className="w-full h-full bg-black rounded-4xl bg-cover bg-center flex overflow-x-hidden shadow-4-sided"
      ...
      >
        ...
        <div className="main w-[50%] max-lg:w-[100%] flex flex-col items-center p-20 justify-center gap-[20px]">
          ...
          >
            Code That Works. Designs That Wow. Experiences That Last.
          </h2>
          <p
            ref={paragraphRef}
            className="text-white text-[1rem] font-[font6] leading-[1.2] text-center px-10"
          >
            Your digital presence should be more than just functional—it should
            be unforgettable. We build high-performance websites that seamlessly
            blend innovation with usability.
          </p>
        </div>
